...
public class Index5 {
    ...
    * Constructor to initialize the data structures.
    ...
    //---------------------------------------------
    /**
     * print the posting list of a term.
    ...
    **/
    ...
    public void printDictionary() {
        ...
        while (it.hasNext()) {
            // Gets the word and its DictEntry.
            Map.Entry pair = (Map.Entry) it.next();
            DictEntry dd = (DictEntry) pair.getValue();
            // Print the word, its frequency in documents and the posting list.
     ...
     * @param files the files to build the index from.
     */
    public void buildIndex(String[] files) {  // from disk not from the internet
        int fid = 0;
        for (String fileName : files) {
            try (BufferedReader file = new BufferedReader(new FileReader(fileName))) {
                // if the file is not in the sources add it.
                if (!sources.containsKey(fileName)) {
                    ...
                    sources.get(fid).title = title;
                }
                String ln;
                int flen = 0;
                // read the file line by line
                while ((ln = file.readLine()) != null) {
                    // add the line to the text of the file.
                    sources.get(fid).text += ln;
...
//        String[] words = ln.split("\\W+");
        // normalizing and tokenizing text data.
...
//        return s.toString();
    ...
    Posting intersect(Posting pL1, Posting pL2) {
        ...
        while (pL1 != null && pL2 != null) {
            // if the docId of the two postings are the same then, add it to the answer
            if(pL1.docId == pL2.docId) {
                // if it's the first element in the answer list
                if (answer == null) {
    ...
    /**
     * search for a phrase in the collection.
    ...
    /**
     * store the index to the hard disk.
     * @param storageName
     */
    public void store(String storageName) {
        try {
            String pathToStorage = "test\\"+storageName;
